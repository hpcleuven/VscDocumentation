...
.. tab-set::
   ...
   .. tab-item:: KU Leuven/UHasselt
      ...
      You need to login via the :ref:`VSC Firewall <https://firewall.vscentrum.be/>` page,
...
.. tab-set::
   ...
   .. tab-item:: KU Leuven/UHasselt
      ...
      You receive a push notification on the `VSC firewall <https://firewall.vscentrum.be/>`
