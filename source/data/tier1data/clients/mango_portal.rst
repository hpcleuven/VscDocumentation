...
The `KU Leuven ManGO portal`_ is a graphical web interface for Tier-1 Data.
...
- Select 'Enter portal' to enter that zone via the `KU Leuven ManGO portal`_.
...
If you select the first option, you will be sent to the `KU Leuven ManGO portal`_ home page:
