...
#. Only once: install the ``step`` CLI. See the `Smallstep
   installation`_ documentation for more information.
   ...
   .. tab-set::
      ...
      .. tab-item:: Linux
         ...
         Install the ``step-cli`` and ``step-ca`` packages. Instructions
         for specific Linux distributions can be found on the `Smallstep
         installation`_ documentation page.

#. Only once: set up (bootstrap) the environment. This creates the
   ``~/.step`` directory.
