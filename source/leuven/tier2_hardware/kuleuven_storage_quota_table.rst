...
|                       | ``/gpfs/scratch/3../vsc3....``   | GPFS   |               | ???   |               |
+-----------------------+----------------------------------+--------+---------------+-------+---------------+
|``$VSC_SCRATCH_LUSTRE``|``/scratch/leuven/3../vsc3....``  | Lustre | Mindwell      | No    | 500 GiB       |
+-----------------------+----------------------------------+--------+---------------+-------+---------------+
|``$VSC_SCRATCH_GPFS``  |``/gpfs/scratch/3../vsc3....``    | GPFS   | Genius & wICE | No    | 500 GiB       |
+-----------------------+----------------------------------+--------+---------------+-------+---------------+
...
+-----------------------+----------------------------------+--------+---------------+-------+---------------+
|``$VSC_SCRATCH_SITE``  | ``$VSC_SCRATCH_LUSTRE``          | Lustre | Genius        | No    | 500 GiB       |
|                       | ``$VSC_SCRATCH_LUSTRE``          | Lustre | wICE          |       |               |
