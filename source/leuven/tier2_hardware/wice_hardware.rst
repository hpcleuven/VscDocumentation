...
- 240 thin nodes
  ...
  - 172 IceLake nodes
    ...
    - 256 GiB RAM
    - default memory per core is 3455 MB
  ...
  - 68 Sapphire Rapids nodes
    ...
    - 256 GiB RAM
    - default memory per core is 2500 MB
    - 960 GB SSD local disk
...
- 5 big memory nodes
  ...
  - 2048 GiB RAM
  - default memory per core is 28000 MB
  - 960 GB SSD local disk
  - partition ``bigmem``,
...
- 1 huge memory node
  ...
  - 8 TiB RAM
  - default memory per core is 111900 MB
  - 960 GB SSD local disk
  - partition ``hugemem``,
    :ref:`submit options <submit to wice big memory node>`
...
- 8 GPU nodes
  ...
  - 4 nodes with 16 A100 GPUs in total
    ...
    - 2 Intel Xeon Platinum 8360Y CPUs\@2.4 GHz (Ice lake),
      ...
      (2 NUMA domains and 1 L3 cache per CPU)
    - 512 GiB RAM
    - default memory per core is 7000 MB
  ...
  - 4 nodes with 16 H100 GPUs in total
    ...
    - 768 GiB RAM
    - default memory per core is 11700 MB
...
- 4 interactive nodes and 1 debug node
  ...
  - 2 Intel Xeon Gold 8358 CPUs\@2.6 GHz (Ice lake),
    ...
    (2 NUMA domains and 1 L3 cache per CPU)
  - 512 GiB RAM
  - default memory per core is 7500 MB
