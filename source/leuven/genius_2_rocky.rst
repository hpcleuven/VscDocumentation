...
=========================
The :ref:`Genius <Genius hardware>`_ operating system will be changed from CentOS 7 to Rocky 8. This is the same OS as currently running on :ref:`wICE <wice hardware>`. 
