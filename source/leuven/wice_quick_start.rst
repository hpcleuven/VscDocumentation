...
:ref:`Genius login nodes <genius_login_nodes>`.
...
More information about accounting used on wice can be found on :ref:`Leuven accounting <accounting_leuven>`
...
We also configured the GPU nodes as shared resources, meaning that different users can 
