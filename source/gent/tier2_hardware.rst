...
================ ========== =========================================================== ===================== =========================== ======================= ===================
doduo            64         2 x 48-core AMD EPYC 7552 (Rome @ 2.2 GHz)                  250 GiB               180 GB SSD                  HDR-100 InfiniBand      RHEL 9
...
Intended usage is mainly for interactive work, either via an interactive job or using the `HPC-UGent web portal <https://docs.hpc.ugent.be/Linux/web_portal/>`__.
...
For more information, see our `documentation <https://docs.hpc.ugent.be/Linux/interactive_debug/>`__.
