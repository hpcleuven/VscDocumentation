...
a graphical file browser, an X server, and an SSH agent, and more, all in one.
No installation is required when using the *Portable edition*. See here for
detailed instructions on how to setup MobaXterm:

:ref:`Setup access using MobaXterm <access_using_mobaxterm>`
